...
fn=saved_models/paper_results/cnn_results/last_epoch_effv2_cross_all_structures_lr00001_drop05.pth.tar		# Feed forward network to use as metric
save_name=saved_models/wgan_dc_cross_all_TT.pth.tar
# load_name=saved_models/paper_results/gan_results/wgan_dc_cross_cylinder_TT.pth.tar
