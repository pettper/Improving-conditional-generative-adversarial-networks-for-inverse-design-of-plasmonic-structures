...
class ModelTrainer:
    ...
    def __init__(self, model, optimizer, loss_function, training_loader, validation_loader, device, metric=None,
                 load_model_filename=None, save_model_filename=None, has_weighted_loss_function=None,
    ...
    def train_model(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            epoch_validation_loss, epoch_validation_metric = self.calculate_validation_loss()
            ...
            if epoch_validation_loss < self.best_validation_loss and self.save_model_filename:
    ...
    def save_on_last_epoch(self):
        ...
        state = torch.load(self.save_model_filename)
        ...
        last_epoch_filename = (self.save_model_filename[:index_of_last_slash+1] + "last_epoch_" +
