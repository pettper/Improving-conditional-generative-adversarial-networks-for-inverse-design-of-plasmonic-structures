...
from src.efficient_net_v2 import InverseEfficientNetV2
from src.utils import EfficientNetV2Data


class EffNetV2Generator(nn.Module):
    ...
    def __init__(self, out_channels, z_dim=100, y_dim=81, image_size=128):
        ...
        self.upsampling_block = InverseEfficientNetV2(out_channels, z_dim, image_size=image_size)
        ...
        self.upsampling_input_layer = nn.Sequential(
            nn.Linear(in_features=z_dim, out_features=EfficientNetV2Data.CHANNELS.value[-1]),
        )
