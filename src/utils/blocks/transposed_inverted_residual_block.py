...
class TransposedInvertedResidualBlock(nn.Module):

    def __init__(self, inp_channels, output_channels, expansion_ratio=6, kernel_size=4, stride=2, padding=1, bias=False,
                 normalization_layer=nn.BatchNorm2d, activation=nn.ReLU()):
        """
        ...
        self.block = nn.Sequential(
            ...
            nn.ConvTranspose2d(in_channels=hidden_dim, out_channels=hidden_dim, kernel_size=kernel_size, stride=stride,
